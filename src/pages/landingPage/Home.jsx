...
export const Home = () => {
  return (
    <main className="flex flex-col gap-18 overflow-hidden">
      ...
      >
        <h2 className="text-3xl md:text-6xl md:text-center">
      ...
      {/* Benefit of our app */}
      <div className={`flex flex-col md:flex-row gap-8 mb-6 ${sectionPadding}`}>
        {BENEFITS.map((el, idx) => (
          <div
          ...
          >
            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <div className="text-[#4F5665] ">{el.desc}</div>
            </div>
          </div>
        ))}
      </div>
      ...
      <div
        className={`mt-34 flex flex-col md:flex-row-reverse items-center gap-6 ${sectionPadding}`}
      >
        <div className="relative w-full bg-[#2948FF] h-40 rounded-lg flex justify-center mb-6 ">
          <img
      ...
      <div
        className={`flex flex-col md:flex-row items-center justify-between gap-4 ${sectionPadding}`}
      >
        <img
          className=""
      ...
      <div className={`flex flex-col gap-8 ${sectionPadding}`}>
        ...
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="rounded-2xl bg-[#2948FF] md:w-[50%]  flex flex-col items-center px-4 py-8 gap-2">
            ...
            {/* User review */}
            <div className="font-normal text-lg text-[#FFFFFF]">
              I've been using the e-wallet for over two years now, and I'm very
              satisfied with the ease of use. This has completely changed the
              way I shop and conduct financial transactions.
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Download The App */}
      <div className={`flex flex-col md:flex-row-reverse gap-4 ${sectionPadding}  mb-20`}>
        <section className=" flex-1 flex flex-col justify-center gap-6 p-33 pl-0">
          <div className="font-medium text-4xl text-[#0B132A]">
            Download The App
          </div>
          ...
          {/* Download Button */}
          <div className="flex gap-8 h-14 w-full">
            <div className="bg-[#2948FF] flex items-center justify-center flex-1 h-full text-[#ffffff] px-6 py-4 gap-4 rounded-md">
              <img src="play-store.svg" alt="Play Store" /> Play Store
            </div>

            <div className="bg-white h-full text-[#2948FF] border border-[#2948FF] px-6 py-4 flex flex-1 items-center justify-center gap-4 rounded-md">
              <div >
